...
<body>
    ...
    <?php
        ...
        if(!empty($dados['AddMsgContato'])){
            ...
            //  Validando todos os campos juntos

            // Retirando espaço em branco dos campos. Essa 'limpeza' serve para os casos de envio de um campo apenas com espaços em branco
